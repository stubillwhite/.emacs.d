...
(let* (
  ...
  (custom-theme-set-faces 'sbw-dark-muted
    ...
    `(helm-rg-active-arg-face                     ((t (:inherit sbw-dark-muted-normal))))
    `(helm-rg-directory-cmd-face                  ((t (:inherit sbw-dark-muted-normal))))
    `(helm-rg-directory-header-face               ((t (:inherit sbw-dark-muted-normal))))
    `(helm-rg-error-message                       ((t (:inherit sbw-dark-muted-error))))
    `(helm-rg-extra-arg-face                      ((t (:inherit sbw-dark-muted-normal))))
    `(helm-rg-file-match-face                     ((t (:inherit sbw-dark-muted-normal))))
    `(helm-rg-line-number-match-face              ((t (:inherit sbw-dark-muted-normal))))
    `(helm-rg-colon-separator-ripgrep-output-face ((t (:inherit sbw-dark-muted-normal))))
    `(helm-rg-match-text-face                     ((t (:inherit sbw-dark-muted-match))))
    `(helm-rg-preview-line-highlight              ((t (:inherit sbw-dark-muted-normal))))
    `(helm-rg-title-face                          ((t (:inherit sbw-dark-muted-normal))))
